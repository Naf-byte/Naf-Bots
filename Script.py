...
def user_input(user_question):
    if user_question.lower() in ["who created you?", "who made you?", "who is your founder?"]:
        st.markdown(
            f"<div style='background-color: #32CD32; color: black; padding: 10px; border-radius: 10px; margin: 10px;'>"
            f" **{{Naf-Chat}}** :  I was created by an amazing team of developers!"
            "</div>",
...
st.write(
    ...
    <div style='text-align:center;'>
        ...
        <p>I'm a chatbot created by an amazing team of developers. My purpose is to assist you with your PDF-related queries.</p>
    </div>
    """,
    unsafe_allow_html=True
)
